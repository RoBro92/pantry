...
function getPendingItemBadge(item: ShoppingListItemSummary) {
  ...
  return { label: "Pantro product", className: "pill is-success" };
}
    ...
    try {
      if (action === "reconcile_selected") {
        ...
        if (newProducts.length > 0) {
          if (!canAdminister) {
            throw new Error("A household admin must create Pantro products for new purchased items before they can be reconciled.");
          }
    ...
    <>
                    ...
                    >
                      <div className="shopping-reconcile-row-mainline">
                        ...
                        <label className="field compact shopping-reconcile-inline-field shopping-reconcile-location-field">
                          <span className="shopping-inline-label">Pantro location</span>
                          <select
                      ...
                      {isExpanded ? (
                        <div className="shopping-reconcile-details">
                          <div className="shopping-reconcile-detail-grid">
                            ...
                            <div className="stack compact-stack">
                              <span className="shopping-detail-label">Pantro location</span>
                          ...
                          <div className="page-actions shopping-reconcile-detail-actions">
                            ...
                            {item.product_external_id === null ? (
                              canAdminister ? (
                                ...
                                >
                                  Create Pantro product
                                </button>
                              ) : (
                                <span className="helper-text">
                                  A household admin must create the Pantro product before this item can be reconciled.
                                </span>
                              )
                            ) : null}
                          </div>
      ...
      {productCreationItem ? (
        <PantryProductDialog
          ...
          mode="create"
          title="Create Pantro product"
          description="Create the missing Pantro product with the full product fields, then return to reconciliation."
