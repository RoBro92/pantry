...
export function MealSuggestionCompleteDialog({
  ...
  return (
    <ModalShell
      ...
      description={`Confirm what Pantro should deduct for ${suggestion.title}.`}
      onClose={onClose}
      panelClassName="modal-panel meal-complete-panel"
    >
      <div className="stack">
        <p className="helper-text">
          Pantro only deducts matched ingredients with compatible pantry units. Missing or extra
            ...
            return (
              <article key={ingredient.id} className="meal-complete-item">
                ...
                <div className="meal-complete-grid">
                  <div className="stack compact-stack">
                    <span className="helper-text">Pantro match</span>
