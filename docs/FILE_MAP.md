...
- `apps/api/app/services/ai_providers/openai_compat.py`: Pantro-owned OpenAI structured-output schema normalization, model-profile hints, and request/error compatibility helpers
...
- `pantro`: repo-root local development wrapper
