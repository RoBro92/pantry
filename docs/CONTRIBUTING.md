...
- optional `PANTRY_LOCAL_AI_*` and `PANTRY_LOCAL_SMTP_*` values in `.env.local` pre-populate local demo-mode AI and SMTP settings without committing secrets to the repo
